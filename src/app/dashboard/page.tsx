...
export default function DashboardHome() {
  ...
  return (
    <div>
      {/* Hero Banner */}
      <div className="relative bg-gradient-to-br from-primary via-primary-dark to-amber-700 rounded-2xl p-8 pb-10 mb-8 text-white overflow-hidden">
      ...
      <div className="grid grid-cols-4 gap-3 mb-8">
        {[
          ...
          >
            ...
            <span className="text-sm font-semibold text-secondary">{cat.label}</span>
          </Link>
        ))}
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/dashboard/notices" className="text-xs text-primary font-semibold hover:underline">전체보기</Link>
        </div>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-lg font-bold text-secondary">판매중 상품</h3>
          <span className="text-xs bg-primary/10 text-primary font-semibold px-2.5 py-1 rounded-full">{saleProducts.length}개</span>
        </div>
