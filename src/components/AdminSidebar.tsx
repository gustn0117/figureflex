...
const menuItems = [
  ...
  },
  {
    ...
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" /><path d="M9 14l2 2 4-4" /></svg>
  },
  {
    ...
    <aside className="w-56 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0">
      ...
      <div className="px-5 py-5 border-b border-gray-100">
        <Link href="/admin" className="flex items-center gap-2.5">
          <img src="/logo.jpg" alt="피규어플렉스" className="h-7 w-auto object-contain" style={{ mixBlendMode: 'multiply' }} />
          <div>
            <p className="text-[13px] font-bold text-gray-900 leading-none">피규어플렉스</p>
            <p className="text-[10px] text-gray-400 mt-0.5 tracking-wider font-medium">ADMIN</p>
          </div>
        </Link>
      </div>
        ...
        <div className="px-4 py-3 border-b border-gray-100 bg-gray-50">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-full bg-gray-900 flex items-center justify-center flex-shrink-0">
              <span className="text-white text-[10px] font-bold">{currentUser.name[0]}</span>
            </div>
      ...
      <div className="px-3 py-3 border-t border-gray-100">
        <button
          ...
          className="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-[13px] text-gray-400 hover:bg-gray-100 hover:text-gray-700 transition-all"
        >
